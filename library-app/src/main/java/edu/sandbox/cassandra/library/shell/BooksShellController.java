...
public class BooksShellController {
    ...
    private final edu.sandbox.cassandra.library.services.BooksService booksService;
    ...
    public String create(@ShellOption("-t") String title, @ShellOption("-g") String genreId,
        ...
        edu.sandbox.cassandra.library.domain.Book book = bookArgumentMapper.map(title, genreId, authorIds);
    ...
    public String update(@ShellOption("-i") String id, @ShellOption("-t") String title,
        ...
        edu.sandbox.cassandra.library.domain.Book book = bookArgumentMapper.map(id, title, genreId, authorIds);
        return bookToStringResponseMapper.map(booksService.save(book));
    }
